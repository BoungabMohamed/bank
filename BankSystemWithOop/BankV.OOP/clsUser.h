...
public:
    ...
    enum enPermissions { eAll = -1, pListClients = 1, pAddNewClient = 2, pDeleteClient = 4, pUpdateClients = 8, pFindClient = 16, pTranaction = 32, pManageUsers = 64 , pScreenOfLogIn = 128};
